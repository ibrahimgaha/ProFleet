"""
Django settings for pro_fleet project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-w5=h*ab*#*6jg&*)rw4ux!qczi3$)act@!t!01kh5e$l4-+pn^')
...
WSGI_APPLICATION = 'pro_fleet.wsgi.application'
